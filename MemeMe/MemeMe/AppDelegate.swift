...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    let tintColor = UIColor(red: 0.071, green: 0.573, blue: 0.878, alpha: 1)
    let backgroundColor = UIColor(red: 0.157, green: 0.157, blue: 0.157, alpha: 1)
    ...
    func setup()
    {
        ...
        UIToolbar.appearance().tintColor = self.tintColor
        
        //Appearance of NavigationBars
